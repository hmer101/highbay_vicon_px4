...
def generate_launch_description():
    ...
    device_id_env = os.environ.get('DEVICE_ID', DEFAULT_DEVICE_ID) # Note must first set environment variable with export DRONE_ID=1
    ...
    config = os.path.join(
    get_package_share_directory('highbay_vicon_px4'),
    'config',
    'manual.yaml'
    ) 
